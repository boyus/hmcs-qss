...
% output matrix A used in Cholesky Decomposition, Jacobian determinant JacDet, and potential gradients u
% no need to output probabilities prob, which are all 1 in primitive prior

function [A, JacDet, u] = cholesky_2qb_flat(q,d,Q)
...
% indM3, indM4 and indM5 are used to compute partial traces
